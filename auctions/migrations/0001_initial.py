# Generated by Django 3.0.2 on 2022-01-23 21:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_price', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('time_create', models.DateTimeField(auto_now_add=True)),
                ('active', models.CharField(choices=[(0, 'Active'), (1, 'Sold')], default=0, max_length=30, verbose_name='STATUS')),
                ('category', models.CharField(choices=[('0', 'No Category'), ('1', 'Arts'), ('2', 'Books'), ('3', 'DVDs'), ('4', 'Electronics'), ('5', 'Fashion'), ('6', 'Health'), ('7', 'Home'), ('8', 'Music'), ('9', 'Toys'), ('10', 'Video Games')], default='0', max_length=30, verbose_name='Categories')),
